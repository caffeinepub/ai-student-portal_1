...
const Q: Record<string, StaticQuestion[]> = {
  ...
  programming: [
    // Easy
    {
      ...
      difficulty: "Easy",
      question_text: "Which is the correct way to print 'Hello' in Python?",
      options: [
        "echo('Hello')",
        "print('Hello')",
        "console.log('Hello')",
    ...
    },
    {
      ...
      difficulty: "Easy",
      question_text:
        "Which symbol is used for single-line comments in Java and C?",
      options: ["#", "//", "--", "/*"],
      correct_option_index: BigInt(1),
    },
    {
      ...
      topic_id: "programming",
      difficulty: "Easy",
      question_text: "What does 10 % 3 evaluate to?",
      options: ["3", "1", "0", "2"],
      correct_option_index: BigInt(1),
    },
    {
      ...
      topic_id: "programming",
      difficulty: "Easy",
      question_text: "Which loop always runs at least once?",
      options: ["for", "while", "do-while", "foreach"],
      correct_option_index: BigInt(2),
    },
    {
    ...
    },
    {
      ...
      topic_id: "programming",
      difficulty: "Easy",
      question_text: "Which data type stores True/False?",
    ...
    },
    {
      ...
      topic_id: "programming",
      difficulty: "Easy",
      question_text: "What does 'increment' mean for a variable?",
      options: [
        "Decrease by 1",
        "Reset to 0",
        "Increase by 1",
    ...
    },
    {
      ...
      difficulty: "Medium",
      question_text:
        "Which sorting algorithm has best average complexity of O(n log n)?",
      options: [
        "Bubble Sort",
        "Insertion Sort",
        "Merge Sort",
    ...
    },
    {
      ...
      topic_id: "programming",
      difficulty: "Medium",
      question_text: "What is a stack overflow in recursion?",
      options: [
        "Memory allocation error",
        "Too many nested recursive calls exhausting stack memory",
        "Syntax error",
        "Logic error",
      ],
      correct_option_index: BigInt(1),
    ...
    },
    {
      ...
      topic_id: "programming",
      difficulty: "Medium",
      question_text: "What is a null/None value?",
    ...
    },
    {
      ...
      difficulty: "Medium",
      question_text:
        "What is the index of the first element in most languages?",
      options: ["1", "0", "-1", "2"],
      correct_option_index: BigInt(1),
    },
    // Hard
    {
      ...
      options: [
        ...
        "Describing algorithm performance as input size grows",
    ...
    },
    {
      ...
      options: [
        "A compiler error",
        "Undecidable problem: cannot determine if program halts",
    ...
    },
    {
      ...
      topic_id: "programming",
      difficulty: "Hard",
      question_text: "What is tail recursion optimization?",
      options: [
        "Slowing down recursion",
        "Compiler converts tail-recursive calls to loops to save stack space",
        "Adding extra base cases",
        "Memoizing results",
      ],
      correct_option_index: BigInt(1),
    },
    ...
    },
    {
      ...
      options: [
        "No difference",
        "Value copies the data; reference passes memory address",
    ...
    },
    {
      ...
      topic_id: "programming",
      difficulty: "Hard",
      question_text: "What is SOLID in object-oriented programming?",
      options: [
        "A language feature",
    ...
    },
    {
      ...
      options: [
        "Runtime programming",
        "Optimization by storing subproblem results to avoid recomputation",
    ...
    },
    {
      ...
      options: [
        "No difference",
        "Compile-time caught before execution; runtime during execution",
        "Runtime caught before execution",
    ...
    },
    {
      ...
      options: [
        "Same object all the time",
        "One interface or method name with multiple implementations",
